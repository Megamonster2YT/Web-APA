...
// Comentario: Este custom hook detecta cuando una sección entra en la vista del usuario
// para aplicar un efecto de "fade-in". Se utiliza para crear una animación de scroll.
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ...
      },
      {
        ...
        rootMargin: '0px',
        threshold: 0.1, // El 10% del elemento es visible para que se active
      }
    );
...
// Comentario: Componente principal de la aplicación, contiene toda la estructura de la landing page.
const App = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    // Lógica para enviar el formulario a Formspree o cualquier otro servicio
  ...
  // Datos de los miembros del equipo y proyectos. Puedes personalizarlo.
  const teamMembers = [
  ...
  // Aplicamos el hook de animación a cada sección
